...
As we can see in the summary above most of the parameters configurations gave similar results except configuration $b3$ which stands for $\lambda=4n,\ \mu=\lambda/2$. It has doubled offspring number in comparison with default configuration. Also better than default were configurations labeled:
